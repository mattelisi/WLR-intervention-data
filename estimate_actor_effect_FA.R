...
#      IM37 IM38 JM38 JM39 JM40 JM43 JM48 JM50 JM33 JM36
#(IM36 IM37 IM38 JM38 JM39 JM40 JM43 JM48 JM50) - these were those in HS task
# there are two Jordanian control kids who have been tested with actor 2 at time 3 

# make dataset using additional data to estimate the effect of the different actor
...
#d_check <- d_check[which(d_check$ethni== "S"),] # only keep syrian here
d_check <- d_check[which(d_check$time!= "SSC"),] # these are from a summer school of syrian in the UK
...
# plot posterior distributions and Gaussian approximations
# the posterio is essentially Gaussian
...
# tehse will be used in the full model as prior
...
write.table(prior_actor, file="./data_bias/additional_data/prior_actor_FA.txt",row.names=F,quote=F)
